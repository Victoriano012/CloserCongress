...
export const PARTIES: Party[] = [
  {
    ...
    stance: "We vote YES on anything that protects or expands access to abortion, contraception and fertility care, because that choice belongs to the person making it. We vote NO on restrictions, funding bans and fetal-personhood measures.",
  ...
  },
  {
    ...
    stance: "We vote YES on restricting abortion, defunding abortion providers and recognising fetal rights, because every life deserves protection. We vote NO on expanding abortion access or federal abortion funding.",
  ...
  },
  {
    ...
    stance: "We vote NO on new restrictions on firearms, magazines, registries and purchases, because your right to keep and bear arms is not up for negotiation. We vote YES on expanding carry rights and preempting state gun laws.",
  ...
  },
  {
    ...
    stance: "We vote YES on background checks, waiting periods, red-flag laws and assault-weapon limits, because common-sense rules save lives. We vote NO on loosening firearm restrictions.",
  ...
  },
  {
    ...
    stance: "We vote YES on emissions cuts, clean-energy investment, conservation and pollution limits, because the science leaves no time to waste. We vote NO on fossil-fuel subsidies, drilling expansion and environmental rollbacks.",
  ...
  },
  {
    ...
    stance: "We vote YES on domestic energy production, permitting reform, pipelines and nuclear, because affordable, reliable energy powers everything else. We vote NO on rules that raise energy costs or block extraction.",
  ...
  },
  {
    ...
    stance: "We vote YES on legal pathways, asylum protections, refugee admissions and detention oversight, because a nation of immigrants should keep its doors open. We vote NO on mass deportation, detention expansion and asylum limits.",
  ...
  },
  {
    ...
    stance: "We vote YES on enforcement funding, tighter asylum rules and deportation of people without status, because a secure border comes first. We vote NO on amnesty, expanded immigration and benefits for people without status.",
  ...
  },
  {
    ...
    stance: "We vote YES on expanding coverage, capping drug prices and funding public health, because getting sick should never mean going broke. We vote NO on coverage cuts and Medicaid restrictions.",
  ...
  },
  {
    ...
    stance: "We vote YES on price transparency, HSAs, faster approvals and interstate competition, because choice and competition bring prices down. We vote NO on single-payer, price controls and insurance mandates.",
  ...
  },
  {
    ...
    stance: "We vote YES on higher taxes on top earners and corporations, closing loopholes and IRS enforcement, because everyone should pay their fair share. We vote NO on tax cuts skewed to the wealthy.",
  ...
  },
  {
    ...
    stance: "We vote YES on cutting taxes and simplifying the code, because your money is yours. We vote NO on tax increases, new taxes and expanded IRS authority.",
  ...
  },
  {
    ...
    stance: "We vote YES on extending anti-discrimination protection and civil-rights enforcement to groups that lack it, because one rule should apply to everyone. We vote NO on measures that narrow those protections or treat a protected group worse than others.",
  ...
  },
  {
    ...
    stance: "We vote YES on parental authority over minors, traditional marriage and limits on gender-transition policy for minors, because strong families make a strong society. We vote NO on measures that transfer parental decisions to schools or agencies, or that redefine marriage or family in federal law.",
  ...
  },
  {
    ...
    stance: "We vote YES on religious-liberty and conscience protections, aid to the poor, and support for faith-based institutions, because faith, charity and human dignity belong together. We vote NO on restricting religious practice, on abortion, and on the death penalty.",
  ...
  },
  {
    ...
    stance: "We vote NO on public funding of religion, religious exemptions from general law and religious content in public institutions, because government should belong to everyone. We vote YES on strict church-state separation.",
  ...
  },
  {
    ...
    stance: "We vote YES on higher wages, union rights, workplace safety and worker benefits, because the people who do the work deserve a seat at the table. We vote NO on right-to-work laws and weakening labour protections.",
  ...
  },
  {
    ...
    stance: "We vote YES on cutting red tape, small-business credit and limiting mandates on small employers, because Main Street should spend its time serving customers, not filling in forms. We vote NO on new compliance burdens and costly employment mandates.",
  ...
  },
  {
    ...
    stance: "We vote YES on sentencing reform, police accountability, re-entry programmes and drug decriminalisation, because a justice system should repair, not just punish. We vote NO on longer mandatory minimums and prison expansion.",
  ...
  },
  {
    ...
    stance: "We vote YES on police funding, tougher sentences and anti-crime enforcement, because safe streets come first. We vote NO on reducing sentences, cutting police budgets or loosening bail.",
  ...
  },
  {
    ...
    stance: "We vote YES on defence spending, military readiness, alliances and aid to allies, because strength keeps the peace. We vote NO on defence cuts and troop withdrawals.",
  ...
  },
  {
    ...
    stance: "We vote NO on military intervention, arms transfers and defence-budget growth, because endless war serves no one at home. We vote YES on war-powers limits, diplomacy and bringing troops home.",
  ...
  },
  {
    ...
    stance: "We vote YES on anything that reduces animal suffering or protects wildlife and pets, because they cannot speak for themselves. We vote NO on anything that weakens animal protections.",
  ...
  },
  {
    ...
    stance: "We vote YES on privacy protections, encryption and limits on surveillance, because your data and your devices are your business. We vote NO on warrantless surveillance, encryption backdoors and broad censorship powers.",
  ...
  },
  {
    ...
    stance: "We vote YES on public education funding, teacher pay, student-debt relief and school meals, because public schools take every child. We vote NO on diverting public money to private schools.",
  ...
  },
  {
    ...
    stance: "We vote YES on vouchers, charters, homeschooling freedom and local curriculum control, because families know their children best. We vote NO on expanding federal control of schools.",
  ...
  },
  {
    ...
    stance: "We vote YES on transparency, ethics rules, lobbying limits and campaign-finance reform, because public office is a trust, not a business. We vote NO on secrecy, earmark abuse and self-dealing.",
  ...
  },
  {
    ...
    stance: "We vote NO on anything that adds materially to the deficit, whether spending or unfunded tax cuts, because the bill always comes due. We vote YES on deficit reduction and spending discipline.",
  ...
  },
  {
    ...
    stance: "We vote YES on sustaining or increasing federal spending on public services and infrastructure, because some things are worth borrowing for. We vote NO on across-the-board cuts, caps and rescissions justified by the deficit alone.",
  ...
  },
  {
    ...
    stance: "We vote YES on veterans' benefits, VA funding and service-member pay, because a promise made in uniform must be kept. We vote NO on cutting veterans' programmes.",
  ...
  },
  {
    ...
    stance: "We vote YES on farm support, rural infrastructure and protecting agricultural land, because the country depends on the people who feed it. We vote NO on rules that raise costs for family farms.",
  ...
  },
  {
    ...
    stance: "We vote YES on building housing, housing assistance and anti-homelessness funding, because everyone needs a home they can afford. We vote NO on cutting housing programmes.",
  ...
  },
  {
    ...
    scope: "Nothing. We have no opinions, by design.",
